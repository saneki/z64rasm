...
;  Despite never being used on emulator, apparently [0x80780000, 0x807A3FCC) is written to,
;  or unstable or something. [0x807A4000, 0x807DA800) does seem to be unused/stable.
;
